...
#home-overlay #asteroid1:hover {
  transform: rotate(60deg);
  right: -15%;
}

#home-overlay #asteroid2 {
  position: absolute;
  width: 200px;
  bottom: 35%;
  right: -55%;
...
#home-overlay #asteroid2:hover {
  transform: rotate(10deg);
  right: -60%;
}

#home-overlay #asteroid3 {
  position: absolute;
  width: 130px;
  top: 5%;
  right: -15%;
...
#home-overlay .welcome-buttons {
    margin-top: 10px;
    display: flex;
    gap: 20px;
}

#home-overlay .welcome-buttons button {
    font-size: 20px;
    font-family: 'Exo 2', sans-serif;
    color: white;
    padding: 10px 20px;
...
#home-overlay .welcome-buttons button:hover {
